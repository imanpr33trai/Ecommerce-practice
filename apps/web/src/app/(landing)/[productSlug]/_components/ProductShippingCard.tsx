...
export const ProductShippingCard = ({ shippingInfo }: ProductShippingCardProps) => {
    const mockShipping = shippingInfo || [
        { title: 'Cost', details: 'Free nationwide shipping' },
        { title: 'Delivery', details: 'Arrives in 5-7 business days. White glove delivery available.' },
