...
export const ProductSpecificationsCard = ({ specifications }: ProductSpecificationsCardProps) => {
            ...
            <CardContent className="space-y-4 text-neutral-300">
                {mockSpecs.map((spec, index) => (
                    <div key={spec.label}>
                        ...
                        {index < mockSpecs.length - 1 && <Separator className="bg-neutral-700/50 my-2" />}
                    </div>
                ))}
            </CardContent>
        </FrostedCard>
