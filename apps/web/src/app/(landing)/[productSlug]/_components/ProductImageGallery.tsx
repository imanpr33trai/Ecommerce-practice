...
export const ProductImageGallery = ({ product }: ProductImageGalleryProps) => {
    ...
    return (
        <div className="relative rounded-2xl bg-neutral-800 p-4 lg:p-6 shadow-xl">
            {/* Main Product Image */}
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl">
                ...
                <div className="absolute top-4 right-4 rounded-full bg-white/10 backdrop-blur-sm px-4 py-2 flex items-center gap-1 text-white">
                    ...
                    {product.images.map((image) => (
                        <div
                            ...
                            className={cn(
                                ...
                                mainImage === image.url ? "border-blue-500" : "border-transparent hover:border-gray-600"
                            )}
